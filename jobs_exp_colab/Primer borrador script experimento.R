...
PARAM <- list()
PARAM$experimento <- "KA4210 version2"

PARAM$semilla_primigenia <- 777787 # cambie 102191 por 777787

dataset <- "./datasets/dataset.csv" # AGREGADO MIO
PARAM$input$dataset <- "./datasets/dataset.csv" # cambié "./datasets/competencia_01.csv" por "./datasets/competencia_01_LGBM.csv"
