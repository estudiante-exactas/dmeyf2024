...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$lag2 <- FALSE # no me engraso con los lags de orden 2 LO CAMBIOMARTES10AM
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202106, 202105, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007,  202002,202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902,201901) # agrego 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002,202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902,201901 y agrego 202105 al principio
...
wf_resultado_semilla750317_sincanarito_ML_UVA_optimizacion_posfijo_menosmesesTENDLAG2 <- function( pnombrewf )
{
...
wf_resultado_semilla750317_sincanarito_ML_UVA_optimizacion_posfijo_menosmesesTENDLAG2()